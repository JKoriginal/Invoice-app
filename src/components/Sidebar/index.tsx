    ...
    menuItems: [
      ...
      },
      {
        icon: (
          ...
          >
            <path
              d="M9 0.5C4.05 0.5 0 4.55 0 9.5C0 14.45 4.05 18.5 9 18.5C13.95 18.5 18 14.45 18 9.5C18 4.55 13.95 0.5 9 0.5ZM9 16.5C5.135 16.5 2 13.365 2 9.5C2 5.635 5.135 2.5 9 2.5C12.865 2.5 16 5.635 16 9.5C16 13.365 12.865 16.5 9 16.5ZM9 6C8.45 6 8 6.45 8 7V10.5C8 10.78 8.22 11 8.5 11H11.5C11.78 11 12 10.78 12 10.5C12 10.22 11.78 10 11.5 10H9.5V7C9.5 6.45 9.05 6 9 6Z"
              fill="currentColor"
            />
          </svg>
        ),
...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <ClickOutside onClick={() => setSidebarOpen(false)}>
      <aside
        className={`w-60.5 absolute left-0 top-0 z-9999 flex h-screen flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
