...
import DeleteConfirmation from "@/app/ui/alerts/ClientDeleteconfirmation";
...
const clientData: Client[] = [
  {
    ...
    Company: "virtusa",
    Telephone: "071 123 4567",
    status: "Active",
  },
  {
    name: "chamila fonseka",
    Email: "schoolofpte@eblix.com.au",
    Company: "E blix",
    Telephone: "071 123 4568",
    status: "Active",
  },
  {
    name: "chamara kapugedara",
    Email: "schoolofpte@eblix.com.au",
    Company: "OLanka",
    Telephone: "071 123 4569",
    status: "Inactive",
  },
  {
    name: "sudath mahesh",
...
const TableClient = () => {
  ...
  const handleSaveClick = () => {
    if (editingIndex !== null) {
      ...
      updatedClients[editingIndex] = editingClient as Client;
                        ...
                        <div className="flex items-center space-x-3.5">
                          ...
                          >
                            ...
                            >
                              ...
                              />
                              <path
                                d="M8.99991 7.09668C8.67278 7.09668 8.40353 7.36593 8.40353 7.69306V13.6687C8.40353 13.9958 8.67278 14.2651 8.99991 14.2651C9.32703 14.2651 9.5962813.6687V7.69306C9.59628 7.36593 9.32703 7.09668 8.99991 7.09668ZM11.8652 7.09668C11.538 7.09668 11.2688 7.36593 11.2688 7.69306V13.6687C11.2688 13.9958 11.538 14.2651 11.8652 14.2651C12.1923 14.2651 12.4616 13.9958 12.4616 13.6687V7.69306C12.4616 7.36593 12.1923 7.09668 11.8652 7.09668ZM6.13464 7.09668C5.80752 7.09668 5.53827 7.36593 5.53827 7.69306V13.6687C5.53827 13.9958 5.80752 14.2651 6.13464 14.2651C6.46177 14.2651 6.73102 13.9958 6.73102 13.6687V7.69306C6.73102 7.36593 6.46177 7.09668 6.13464 7.09668Z"
                                fill=""
                              />
                            </svg>
                          </button>
